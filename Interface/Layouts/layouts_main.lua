...
do
        ...
        get = function(self)
            if not eF.optionsTable.currently_selected_layout then
                for k, v in pairs(args) do
                    if not (k == "layout_drop_down" or k == "add_new_layout") then
                        v.disabled = true
                    end
                end
            else
    ...
    args["remove_current_layout"] = {
        ...
        confirm = function()
            ...
            return string.format(
                       "Are you sure you want to delete the layout '%s'? This is not reversible.",
                       eF.optionsTable.currently_selected_layout or
                           "(nothing selected)")
        end,
        name = "Delete",
        func = function(self)
    ...
    args["rename_current_layout"] = {
        ...
        set = function(self, name)
            ...
            local new_name = eF.find_valid_name_in_table(name,
...
do
    ...
    args["load_options"] = {type = "group", name = "Show", args = {}, order = 2}
    ...
    args["flags_options"] = {
        ...
        order = 4,
        args = {
            dead = {type = "group", name = "Dead", args = {}},
            offline = {type = "group", name = "Offline", args = {}},
            mc = {type = "group", name = "MC", args = {}},
            summon = {
                hidden = true, -- toad
                type = "group",
                name = "Summon NYI",
