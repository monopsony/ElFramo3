...
for k, v in ipairs(flag_frames) do
    ...
    args["frame_color"] = {
        ...
        get = function(self)
            ...
            local flag = self[2]
            if not name then return end
            local R, G, B, A = get_current_parameter(flag, "frameR"),
                               get_current_parameter(flag, "frameG"),
                               get_current_parameter(flag, "frameB"),
                               get_current_parameter(flag, "frameA")
            return R, G, B, A
        end
    }
    ...
    args["text_color"] = {
        ...
        get = function(self)
            ...
            local flag = self[2]
            if not name then return end
            R, G, B, A = get_current_parameter(flag, "textR"),
                         get_current_parameter(flag, "textG"),
                         get_current_parameter(flag, "textB"),
                         get_current_parameter(flag, "textA")
            return R, G, B, A
        end
    }
