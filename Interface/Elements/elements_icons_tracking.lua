local eF=elFramo
local elements=elFramo.optionsTable.args.elements.args.tracking.args
...
do
    ...
    args["arg1_name"]={
        type="input",
        order=3,
        hidden=function() if eF.para[eF.optionsTable.currently_selected_element_key].adoptFunc=="Name" then return true else return false end end,
        name="Name",
        set=function(self,value)
    ...
    args["arg1_spellID"]={
        type="input",
        order=3,
        hidden=function() if eF.para[eF.optionsTable.currently_selected_element_key].adoptFunc=="SpellID" then return true else return false end end,
        name="Name",
        set=function(self,value)
            set_current_parameter("arg1",value)
            end,
