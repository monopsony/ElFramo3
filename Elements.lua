...
function eF:update_element_meta(name)
	...
	if para.type=="icon" then
		...
		if tt=="CHAT_MSG" then
			...
			work.msgAdopt=taskFuncs.msgAdopt[para.chatMatch] or function(...) return false end
		...
		if para.hasText then
			...
			if para.textType=="Stacks" then 
				if tt=="HELPFUL" or tt=="HARMFUL" or tt=="PLAYER HELPFUL" or tt=="PLAYER HARMFUL"  then 
					tasks.postAura[#tasks.postAura+1]=taskFuncs.iconUpdateTextTypeS 
				elseif tt=="CHAT_MSG" then
					tasks.onMsg[#tasks.onMsg+1]=taskFuncs.iconUpdateTextTypeS 
				end
			end
		end
		...
		if para.hasText2 then
			...
			if tt=="HELPFUL" or tt=="HARMFUL" or tt=="PLAYER HELPFUL" or tt=="PLAYER HARMFUL"  then 
				tasks.postAura[#tasks.postAura+1]=taskFuncs.iconUpdateText2TypeS 
			elseif tt=="CHAT_MSG" then
